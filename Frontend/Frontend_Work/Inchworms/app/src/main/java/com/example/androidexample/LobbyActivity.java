...
public class LobbyActivity extends AppCompatActivity {
    ...
    private void joinGame() {
        String joinGameUrl = "http://coms-3090-013.class.las.iastate.edu:8080/game/joinByUsername/" + username;
    ...
    private void pollGameStateAndLobbyUsers(String lobbyId) {
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Volley.newRequestQueue(LobbyActivity.this).add(gameStateRequest);
                ...
                Volley.newRequestQueue(LobbyActivity.this).add(usersRequest);
