...
public class ImageUploadActivity extends AppCompatActivity {
    ...
    private static String UPLOAD_URL = "http://10.50.92.98:8080/images";
    ...
    private void uploadImage(){
        ...
        MultipartRequest multipartRequest = new MultipartRequest(
                ...
                response -> {
                    ...
                    // Change background color to green on success
                    findViewById(android.R.id.content).setBackgroundColor(getResources().getColor(android.R.color.holo_green_light));
                },
                error -> {
                    // Handle error
                    Toast.makeText(getApplicationContext(), error.getMessage(),Toast.LENGTH_LONG).show();
                    Log.e("Upload", "Error: " + error.getMessage());
                    // Change background color to red on failure
                    findViewById(android.R.id.content).setBackgroundColor(getResources().getColor(android.R.color.holo_red_light));
                }
        );
