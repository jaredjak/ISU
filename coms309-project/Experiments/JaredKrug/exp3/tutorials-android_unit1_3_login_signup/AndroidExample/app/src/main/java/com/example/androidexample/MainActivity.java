...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras == null) {
            ...
            messageText.setText("Welcome To Insatiable Insatiable Inchworms");
            messageText.setTextColor(Color.parseColor("#00ff00"));
            ...
            View inchLayout = findViewById(R.id.inch);
            inchLayout.setBackgroundResource(R.drawable.inch);
