...
public class CounterActivity extends AppCompatActivity {
    ...
    private Button multBtn;     // define multiply button variable
    private Button divBtn;      // define divide button variable
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        multBtn = findViewById(R.id.counter_multiply_btn);
        divBtn = findViewById(R.id.counter_divide_btn);
        ...
        /* when multiply btn is pressed, counter*2, reset number textview */
        ...
        /* when divide btn is pressed, counter/2, reset number textview */
