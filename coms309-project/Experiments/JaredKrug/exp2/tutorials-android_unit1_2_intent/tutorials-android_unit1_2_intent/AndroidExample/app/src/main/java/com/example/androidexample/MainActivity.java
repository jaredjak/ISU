...
public class MainActivity extends AppCompatActivity {
    ...
    private Button wormButton;       // define scary button variable
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wormButton = findViewById(R.id.main_scary_btn);
        ...
        /* click listener on scary button pressed */
        wormButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                /* when scary button is pressed, use intent to switch to Scary Activity */
                Intent intent = new Intent(MainActivity.this, WormActivity.class);
                startActivity(intent);
            }
        });
    }
